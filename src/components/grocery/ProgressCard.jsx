        ...
        <div>
          ...
          <div className="flex items-center gap-4 bg-slate-50 border border-slate-200 rounded-xl p-1">
            <button 
              ...
              disabled={servings <= 1}
              className="p-2 text-slate-500 hover:text-emerald-600 disabled:opacity-30 disabled:hover:text-slate-500 transition-colors"
            >
              <Minus size={18} />
            </button>
            <div className="flex items-center gap-2 font-bold text-slate-700 w-12 justify-center">
